...
cat <<EOF > namd2_ID0000002-cont.sh
#!/bin/bash
echo -e "\n#################[Container] Now in pegasus lite container script #################"  1>&2
set -e
# setting environment variables for job
EOF
container_env /scratch >> namd2_ID0000002-cont.sh
cat <<EOF2 >> namd2_ID0000002-cont.sh
...
[
 { "type": "transfer",
   ...
   "id": 1,
   "src_urls": [
     { "site_label": "cori", "url": "gsiftp://corigrid.nersc.gov/global/cscratch1/sd/papajim/georgepap/pegasus/namd_wf/run0001/00/00/equilibrate_200.restart.vel", "checkpoint": "false" }
   ],
   "dest_urls": [
 ...
 { "type": "transfer",
   ...
   "id": 4,
   "src_urls": [
     { "site_label": "cori", "url": "gsiftp://corigrid.nersc.gov/global/cscratch1/sd/papajim/georgepap/pegasus/namd_wf/run0001/00/00/production_200.conf", "checkpoint": "false" }
   ],
   "dest_urls": [
 ...
 { "type": "transfer",
   ...
   "id": 5,
   "src_urls": [
     { "site_label": "cori", "url": "gsiftp://corigrid.nersc.gov/global/cscratch1/sd/papajim/georgepap/pegasus/namd_wf/run0001/00/00/equilibrate_200.restart.xsc", "checkpoint": "false" }
   ],
   "dest_urls": [
 ...
 { "type": "transfer",
   ...
   "id": 6,
   "src_urls": [
     { "site_label": "cori", "url": "gsiftp://corigrid.nersc.gov/global/cscratch1/sd/papajim/georgepap/pegasus/namd_wf/run0001/00/00/equilibrate_200.restart.coor", "checkpoint": "false" }
   ],
   "dest_urls": [
...
equilibrate_200.restart.vel:par_all27_prot_lipid.inp:crd.md18_vmd_autopsf.pdb:production_200.conf:equilibrate_200.restart.xsc:equilibrate_200.restart.coor:Q42.psf
eof
...
pegasus-kickstart  -n namd2 -N ID0000002 -R cori  -s production_200.dcd=production_200.dcd -L namd_wf -T 2019-01-31T16:21:05-08:00 /opt/namd2 +p 32 production_200.conf
set -e
...
[
 { "type": "transfer",
   ...
   "dest_urls": [
     { "site_label": "cori", "url": "gsiftp://corigrid.nersc.gov/global/cscratch1/sd/papajim/georgepap/pegasus/namd_wf/run0001/00/00/production_200.dcd" }
   ] }
]
eof
...
chmod +x namd2_ID0000002-cont.sh
...
shifter --image papajim/namd_image:latest --volume /Volumes/Work/lfs1:/shared-data/:ro;$PWD:/scratch --workdir=/scratch papajim/namd_image:latest ./namd2_ID0000002-cont.sh 
job_ec=$(($job_ec + $?))
