...
[
 { "type": "transfer",
   ...
   "id": 1,
   "src_urls": [
     { "site_label": "cori", "url": "file:///global/cscratch1/sd/papajim/georgepap/pegasus/namd_wf/run0001/00/00/equilibrate_200.restart.vel", "checkpoint": "false" }
   ],
   "dest_urls": [
 ...
 { "type": "transfer",
   ...
   "id": 4,
   "src_urls": [
     { "site_label": "cori", "url": "file:///global/cscratch1/sd/papajim/georgepap/pegasus/namd_wf/run0001/00/00/production_200.conf", "checkpoint": "false" }
   ],
   "dest_urls": [
 ...
 { "type": "transfer",
   ...
   "id": 5,
   "src_urls": [
     { "site_label": "cori", "url": "file:///global/cscratch1/sd/papajim/georgepap/pegasus/namd_wf/run0001/00/00/equilibrate_200.restart.xsc", "checkpoint": "false" }
   ],
   "dest_urls": [
 ...
 { "type": "transfer",
   ...
   "id": 6,
   "src_urls": [
     { "site_label": "cori", "url": "file:///global/cscratch1/sd/papajim/georgepap/pegasus/namd_wf/run0001/00/00/equilibrate_200.restart.coor", "checkpoint": "false" }
   ],
   "dest_urls": [
...
pegasus-kickstart  -n namd2 -N ID0000002 -R cori  -s production_200.dcd=production_200.dcd -L namd_wf -T 2019-02-02T01:07:07-08:00 /opt/NAMD_2.12_Linux-x86_64-multicore/namd2 +p 32 production_200.conf
set -e
...
[
 { "type": "transfer",
   ...
   "dest_urls": [
     { "site_label": "cori", "url": "file:///global/cscratch1/sd/papajim/georgepap/pegasus/namd_wf/run0001/00/00/production_200.dcd" }
   ] }
]
eof
...
shifter --image papajim/namd_image:latest --volume $PWD:/scratch --workdir=/scratch ./namd2_ID0000002-cont.sh 
job_ec=$(($job_ec + $?))
