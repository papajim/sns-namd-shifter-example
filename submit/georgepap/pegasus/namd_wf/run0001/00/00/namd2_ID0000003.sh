...
[
 ...
 { "type": "transfer",
   ...
   "id": 4,
   "src_urls": [
     { "site_label": "cori", "url": "file:///global/cscratch1/sd/papajim/georgepap/pegasus/namd_wf/run0001/00/00/equilibrate_250.conf", "checkpoint": "false" }
   ],
   "dest_urls": [
...
pegasus-kickstart  -n namd2 -N ID0000003 -R cori  -s equilibrate_250.restart.xsc=equilibrate_250.restart.xsc -s equilibrate_250.restart.coor=equilibrate_250.restart.coor -s equilibrate_250.restart.vel=equilibrate_250.restart.vel -L namd_wf -T 2019-02-02T01:07:07-08:00 /opt/NAMD_2.12_Linux-x86_64-multicore/namd2 +p 32 equilibrate_250.conf
set -e
...
[
 { "type": "transfer",
   ...
   "dest_urls": [
     { "site_label": "cori", "url": "file:///global/cscratch1/sd/papajim/georgepap/pegasus/namd_wf/run0001/00/00/equilibrate_250.restart.xsc" }
   ] }
 ,
 { "type": "transfer",
   "linkage": "output",
   ...
   "dest_urls": [
     { "site_label": "cori", "url": "file:///global/cscratch1/sd/papajim/georgepap/pegasus/namd_wf/run0001/00/00/equilibrate_250.restart.coor" }
   ] }
 ,
 { "type": "transfer",
   "linkage": "output",
   ...
   "dest_urls": [
     { "site_label": "cori", "url": "file:///global/cscratch1/sd/papajim/georgepap/pegasus/namd_wf/run0001/00/00/equilibrate_250.restart.vel" }
   ] }
]
eof
...
shifter --image papajim/namd_image:latest --volume $PWD:/scratch --workdir=/scratch ./namd2_ID0000003-cont.sh 
job_ec=$(($job_ec + $?))
