...
pegasus-kickstart  -n namd2 -N ID0000003 -R cori  -s equilibrate_250.restart.xsc=equilibrate_250.restart.xsc -s equilibrate_250.restart.coor=equilibrate_250.restart.coor -s equilibrate_250.restart.vel=equilibrate_250.restart.vel -L namd_wf -T 2019-03-28T16:24:54-07:00 /opt/NAMD_2.12_Linux-x86_64-multicore/namd2 +p 32 equilibrate_250.conf
set -e
