...
[
 ...
 { "type": "transfer",
   ...
   "id": 4,
   "src_urls": [
     { "site_label": "cori", "url": "file:///global/cscratch1/sd/papajim/georgpap/pegasus/namd_wf/run0001/00/00/equilibrate_200.conf", "checkpoint": "false" }
   ],
   "dest_urls": [
...
pegasus-kickstart  -n namd2 -N ID0000001 -R cori  -s equilibrate_200.restart.vel=equilibrate_200.restart.vel -s equilibrate_200.restart.xsc=equilibrate_200.restart.xsc -s equilibrate_200.restart.coor=equilibrate_200.restart.coor -L namd_wf -T 2019-03-28T16:24:54-07:00 /opt/NAMD_2.12_Linux-x86_64-multicore/namd2 +p 32 equilibrate_200.conf
set -e
...
[
 { "type": "transfer",
   ...
   "dest_urls": [
     { "site_label": "cori", "url": "file:///global/cscratch1/sd/papajim/georgpap/pegasus/namd_wf/run0001/00/00/equilibrate_200.restart.vel" }
   ] }
 ,
 { "type": "transfer",
   "linkage": "output",
   ...
   "dest_urls": [
     { "site_label": "cori", "url": "file:///global/cscratch1/sd/papajim/georgpap/pegasus/namd_wf/run0001/00/00/equilibrate_200.restart.xsc" }
   ] }
 ,
 { "type": "transfer",
   "linkage": "output",
   ...
   "dest_urls": [
     { "site_label": "cori", "url": "file:///global/cscratch1/sd/papajim/georgpap/pegasus/namd_wf/run0001/00/00/equilibrate_200.restart.coor" }
   ] }
]
eof
