...
pegasus-kickstart  -n namd2 -N ID0000002 -R cori  -s production_200.dcd=production_200.dcd -L namd_wf -T 2019-03-28T16:24:54-07:00 /opt/NAMD_2.12_Linux-x86_64-multicore/namd2 +p 32 production_200.conf
set -e
